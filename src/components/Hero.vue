<script lang="ts" setup>
    import { PhLinkedinLogo, PhGithubLogo, PhReadCvLogo, PhEnvelopeSimple } from "@phosphor-icons/vue";
...
<template>
    <div class="min-h-screen flex items-center justify-center px-4">
        <div class="flex items-center max-w-6xl w-full">
            ...
            <img :src="Headshot.src" alt="Headshot" class="h-80 w-80 rounded-full" />
        </div>
    </div>
</template>
